...
def test_catty(client):
    ...
    with client.session_transaction() as sess:
        sess['catlives'] = '{"alreadyGuessed": false, "answer": ["", "", "", "", "", ""], "guessedLetters": [], "hasLost": false, "hasWon": false, "numberOfGuesses": 6, "word": "macled", "wordLetters": ["m", "a", "c", "l", "e", "d"], "wordLettersRemaining": ["c", "m", "d", "a", "e", "l"]}'
